...
ALL_ENGINES = [
    {"id": "atlas",   "label": "ATLAS",   "desc": "V14 · all-new (Presto + Scribe + gates)"},
    {"id": "presto",  "label": "PRESTO",  "desc": "V12 · typed fast-path"},
    {"id": "classic", "label": "CLASSIC", "desc": "V7 Veritas (legacy)"},
    {"id": "auto",    "label": "AUTO",    "desc": "flag-based default"},
]
